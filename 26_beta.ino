...
#define _DUTY_NEU 1400 // [2952] 서보의 중간 각도값 1475
...
// PID parameters
#define _KP 1.07 // [2957] 비례 제어 값. 서보 각 증가시. 
#define _KD 52
#define _KI 0.01
...
//      else tau = 200;
      if (dist_ema >= 250 && dist_ema <= 260) tau = 1200;
      else if (dist_ema >= 245 && dist_ema <= 265) tau = 700;
      else if (dist_ema >= 240 && dist_ema <= 270) tau = 500;
      else tau = 300;
