...
#define _DUTY_NEU 1420 // [2952] 서보의 중간 각도값 1475
...
#define _SERVO_SPEED 200  //[2959] 서보의 속도 설정

// Event periods+
#define _INTERVAL_DIST 25  //[2959] 센서의 거리측정 인터벌값
#define _INTERVAL_SERVO 10 //[2967] 서보 INTERVAL값 설정
#define _INTERVAL_SERIAL 100  //[2959] 시리얼 모니터/플로터의 인터벌값 설정

// PID parameters
#define _KP 0.9 // [2957] 비례 제어 값. 서보 각 증가시. 
#define _KD 35
...
Serial.begin(115200); // [2952] 시리얼 포트를 57600의 속도로 연결
